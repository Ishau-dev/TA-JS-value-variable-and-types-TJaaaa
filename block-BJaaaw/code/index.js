...
// // 2. Write a program to accept two numbers from user using`prompt` and alert the max value.
   ...
   let  numB= prompt("Enter second number");
    if(numA>numB){
    alert(`Max value is ${numA}`);
    }else{
      alert(`Max value is ${numB}`);
    }
...
// 6. Write a program that takes the number of the month(1 - 12) and alert number of days in the month.
 ...
 switch(month){
   case 1:
     alert("January has 31days");
     break;
   case 2:
     alert("February has 28days");
     break;
   case 3:
     alert("March has 31days");
     break;
   case 4:
      alert("April has 30days");
      break;
   case 5:
      alert("May has 31days");
      break;
   case 6:
      alert("June has 30days");
      break;
   case 7:
      alert("July has 31days");
      break;
    case 8:
      alert("August has 31days");
      break;
    case 9:
      alert("September has 30days");
      break;
    case 10:
      alert("October has 31days");
      break;
    case 11:
      alert("November has 30days");
      break;
    case 12:
      alert("December has 31days");
      break;
      default:
        alert("invalid entry");
 }
...
*/
 ...
 let grossPay = prompt("Enter your gross pay");
 grossPay = Number(grossPay);
 if(grossPay<=20000){
   grossPay= grossPay - (grossPay*0.1);
   alert(grossPay);
 }else if (grossPay<=40000){
  grossPay= grossPay - (grossPay*0.2);
  alert(grossPay);
 }else if (grossPay<=50000){
  grossPay= grossPay - (grossPay*0.3);
  alert(grossPay);
 }else {
   alert("invalid input");
 }
...
let weather= prompt("What is the condition of the the weather?");
switch(weather){
  case "sunny":
